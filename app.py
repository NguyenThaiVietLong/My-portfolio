...
with st.sidebar:
    ...
    choose = option_menu(
                        "Việt Long", 
                        ["About Me", "Experience", "Technical Skills", "Education", "Projects", "Competitions", "Volunteering","Resume", "Contact"],
...
if choose == "About Me":
    ...
    with st.container():
        ...
        with left_column:
            st.header("About Me")
            st.subheader("Aspiring Business Analyst/Data Analyst")
            st.write("👋🏻 Hi, I'm Long! I'm a business analyst and data analyst graduate based in Vietnam. With prior relevant experiences in tech and teaching, I am constantly seeking opportuinity to broaden my horizons not only as a business analyst but also as a data analyst.")
            ...
            st.write("🏋🏻 In addition, I enjoy exercising at the gym, running, traveling, playing video games, and spending time with friends in my free time!")
            st.write("👨🏼‍💻 Academic interests: SQL, Business Analytics, Data Visualization")
            st.write("💭 Ideal Career Prospects: Business Analyst, Data Analyst, Business Data Analyst, Business Intelligence Analyst, Product Owner")
            st.write("📄 [Resume (1 page)](https://drive.google.com/file/d/1PSlwI6Dr8xH_xjLgAY7mXlu2BPRwb1jJ/view?usp=sharing)")
        with middle_column:
            st.empty()
        with right_column:
            st.image(img_utown)
...
# Create section for Work Experience
    ...
    with st.container():
        ...
        with text_column:
            ...
            `Draw.io` `Jira` `Confluence` `Warehouse Management System` `API` `User Story` `UAT` `Story Point` `Agile-Scrum`
            """)
    with st.container():
        image_column, text_column = st.columns((1,5))
        with image_column:
        ...
        with text_column:
            ...
            `Odoo` `HRM` `Jira` `Confluence` `MindManager` `Figma` `Draw.io` 
            """)
...
# Create section for Technical Skills
    ...
    txt3("Documentation", "`BRD`, `User Story`, `Use case`, `BRD`, `FRS`, `SRS`")
    txt3("Diagram", "`BPMN`, `UML(Activity Diagram, Sequence Diagram...)`")
    txt3("UI/UX", "`Wireframe`, `Mockup`, `Prototype`")
    st.header("Tools")
    txt3("Documentation", "`Microsoft tools(Word, Excel, Power Point...)`, `Google drive`")
    txt3("Diagram", "`Draw.io`, `Microsoft Visio`")
    txt3("UI/UX", "`Figma`, `Balsamiq`")
    txt3("Management", "`Confluence`, `Jira`, `Notion`, `Slack`")
    txt3("Development", "`Agile-Scrum`, `Waterfall`")
...
#st.write("---")
    ...
    with st.container():
        ...
        with text_column:
                ...
                st.write("Coursework: Data Analysis, Software Project Management, Database Management Systems, Software Engineering, Python Programming")
                st.markdown("""
    ...
    with st.container():
        ...
        with text_column:
            st.subheader("Identify Positive and Negative Comments on Youtubee")
...
#         st.write("...and more to come!")
    ...
    resume_url = "https://drive.google.com/file/d/1Ccg3KxDD4fkzJmvBYNE1Ucijq5Wm9b-C/view?usp=drive_link"
    st.header("Resume")
    ...
    show_pdf("NguyenThaiVietLong_Resume.pdf")
    with open("NguyenThaiVietLong_Resume.pdf", "rb") as file:
        btn = st.download_button(
            label="Download Resume (1 page)",
            data=file,
            file_name="NguyenThaiVietLong_Resume.pdf",
...
# Create section for Contact
    ...
    with st.container():
        ...
        with text_column:
            st.write("Let's connect! You may either reach out to me at longntv.work@gmail.com or use the form below!")
